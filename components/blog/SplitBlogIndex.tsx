...
export const SplitBlogIndex = () => (
  <div>
    {(getPagesUnderRoute('/blog') as Array<Page & { frontMatter: any }>).slice(0, 3).map((page) => (
      <Link
        key={page.route}
        href={page.route}
        className="flex flex-col md:flex-row justify-between md:items-center mb-8 group"
      >
