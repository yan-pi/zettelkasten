...
_Tips and Insights by Smoljames (@smoljames)_

## Getting Started

Begin your coding journey with freecodecamp tutorials and courses. You can find
them [here](https://www.freecodecamp.org/learn).
...
- Create full stack applications using modern technologies such as Supabase,
  Prisma, and others.
...
Remember that becoming a software engineer is a journey, and these tips can
serve as a guide along the way. Good luck on your path to becoming a successful
software engineer!
