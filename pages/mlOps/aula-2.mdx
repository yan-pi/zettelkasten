...
Durante a aula o prefessor aprensentou uma ML Pipeline, que é um conjunto de passos que são executados em sequencia para
treinar um modelo de Machine Learning.

Neste exemplo ele mostrou uma pipeline de treinamento de um modelo de classificação de produtos/objetos, utilizando um
