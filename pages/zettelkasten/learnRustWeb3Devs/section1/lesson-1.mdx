...
Podemos verificar essa abordagem olhando para o [repositorio da polkadot-SDK](https://github.com/paritytech/polkadot-sdk/tree/master/substrate/frame), onde temos a estrutura de diretórios e arquivos organizados em modulos dos `Pallets` da Polkadot.
