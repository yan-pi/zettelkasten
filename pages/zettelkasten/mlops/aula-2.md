...
Agora precisamos utilizar o nosso modelo treinado para fazer a classificação dos produtos, o modelo é salvo como um
arquivo `.sav` e precisamos carregar ele para fazer a classificação.
...
Por fim, teremos uma aplicação web funcional com nosso modelo carregado, o front-end dessa aplicação funcionara da mesma
maneira que um serviço web convencional
