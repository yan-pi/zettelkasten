...
This page contains some notes about Math, and some resources to study it, all content are From [Guilherme Noghartt](https://twitter.com/noghartt)
on his [Gist](https://gist.github.com/noghartt/8e6d4188e8a594fbefb113c4fdeee16d).
...
- [MathWiki](https://github.com/zhaoshenzhai/MathWiki) a compiled [[Obsidian]]  vault containing some good contents about Math related themes
...
- #for-later [An Interactive Guide to the Fourier Transform](https://betterexplained.com/articles/an-interactive-guide-to-the-fourier-transform/)
